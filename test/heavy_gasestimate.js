...
contract('Polygon', function (accounts) {
    ...
    beforeEach(async function () {
        contract = await HeavyPolygon.new(polygon);
    ...
    it("Count gas to add points", function () {
        ...
        return contract.addPoints(newPoints, 0).then(function(tr) {
            ...
            console.log("Gas used to add 50 points: " + tr.receipt.gasUsed);
            let _points = generatePoints(50);

            return contract.addPoints(_points, 0, 2);
        }).then(function(tr) {
            console.log("Gas used to insert 50 points: " + tr.receipt.gasUsed);
